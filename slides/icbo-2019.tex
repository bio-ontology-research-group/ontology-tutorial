...
\begin{frame}
  \frametitle{Preliminaries: Description Logic}
  
\end{frame}

\begin{frame}
  \frametitle{Preliminaries: deductive inference}
...
\begin{frame}
  ...
  \item RO and BFO provide a top-level system of classes and relations
    ...
    \end{itemize}
  \item this system defines patterns used to generate graphs
  \end{itemize}
\end{frame}
