...
\begin{frame}
  ...
  \item Reasoning: derive implicitly represented knowledge (e.g.,
    subsumption)
    \pause
  \item remark: my definition of ``knowledge graph'': ABox + RBox
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \begin{itemize}
  \item semantic similarity measures are hand-crafted
    \begin{itemize}
    ...
    \end{itemize}
  \item machine learning methods are data-driven
    \begin{itemize}
  ...
  \item useful for edge prediction, similarity, clustering, as feature
    ...
    \item supervised: edge prediction (e.g., SVM, ANN)
      ...
      \item e.g.: find a function $f:\Re^n \times \Re^n \mapsto [0,1]$
        ...
        is minimized for a set of true labels $\hat{y_k}$
      \end{itemize}
...
\begin{frame}
  \frametitle{Axioms contribute to prediction}
    % \processtable
