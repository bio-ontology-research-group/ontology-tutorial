...
\title[Bio-Ontologies]{Ontologies in computational biology}

\author{Robert Hoehndorf and Paul Schofield}
...
\begin{frame}
  \frametitle{Hands-on part 1}
  \begin{itemize}
  \item start Jupyter and open the Notebook
    \begin{itemize}
    \item https://github.com/bio-ontology-research-group/ontology-tutorial/blob/master/ontology-analysis.ipynb
    \end{itemize}
  \item chose the SciJava kernel
  \item run the ``Reasoning with ontologies'' part
    \begin{itemize}
    \item then modify the code and retrieve all superclasses of
...
\begin{frame}
  ...
  \item can they also be used for data analysis?
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \item run the ``Semantic Similarity'' part
    \begin{itemize}
    \item then find the most similar mouse gene to ``Tetralogy of
      Fallot'' (OMIM:187500)
