...
if (model =="sg"):
	mymodel =gensim.models.Word2Vec(sentences, sg=1, min_count=mincoun, size=mysize ,window=mywindow, sample=1e-3)
else:
	mymodel =gensim.models.Word2Vec(sentences,sg=0,min_count=mincoun, size=mysize ,window=mywindow)
